...
# Aqui has de introducir el codigo
	...
	movl %ecx, %edx
	andl $0x0F, %edx			# Comprueba si es múltiple de 16
	cmpl $0, %edx
	jne for_unaligned
...
for_aligned:
	...
	movdqa (%eax), %xmm0	# mata[k + 0], mata[k + 1], ... , mata[k + 15] -> %xmm0
	movdqa (%ebx), %xmm1	# matb[k + 0], matb[k + 1], ... , matb[k + 15] -> %xmm1
	...
	movdqa %xmm1, (%ecx)	# Carga xmm1 en (%ecx)
